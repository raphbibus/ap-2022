<x-navigation>
    <div class="w-screen xl:bg-lifestyle bg-cover bg-no-repeat bg-fixed bg-center bg-punk-blue dark:bg-darkpunk-blue">
        <div class="min-h-screen basis-full z-10 xl:mr-6 max-h-screen overflow-scroll pb-16 bg-gradient-to-r from-punk-pink via-transparent to-transparent dark:from-darkpunk-pink dark:via-transparent dark:to-transparent">
            <div class="text-center my-12">
                <h1 class="font-display text-5xl xl:text-8xl text-punk-light dark:text-darkpunk-light">lifestyle</h1>
                <div class="grid grid-cols-1 gap-4 my-12 text-center w-5/6 md:w-3/4 2xl:w-1/2 mx-auto">
                    <div class="p-4 xl:p-8 rounded-xl text-punk-light dark:text-darkpunk-light bg-punk-dark/80 dark:bg-darkpunk-dark/80">
                        ...
                        <h2 class="text-2xl xl:text-3xl py-2 break-words">
                            Folge einfach diesen <span class="text-punk-blue dark:text-punk-blue">6 Regeln</span>, die Ralph sich um 22:30 Freitagabend ausgedacht hat.
                        </h2>
                        <p class="text-center font-serif text-xl p-8">
                            <b class="text-punk-blue dark:text-punk-blue">Versuche in Lösungen zu denken.</b> Aber erst, wenn du dir sicher bist, dass es ein Problem gibt.
                        </p>
                        <hr class="mt-2 border-punk-blue dark:border-darkpunk-blue"/>
                        <p class="text-center font-serif text-xl p-8">
                            Sei kein:e Berater:in. Geil dich nicht an Stundensätzen auf. <b class="text-punk-blue dark:text-punk-blue">Fördere Kollaboration, lehre Eigenständigkeit.</b>
                        </p>
                        <hr class="mt-2 border-punk-blue dark:border-darkpunk-blue"/>
                        <p class="text-center font-serif text-xl p-8">
                            Am Tisch ist immer noch Platz für einen weiteren Stuhl. <b class="text-punk-blue dark:text-punk-blue">Freu dich immer über mehr Kommunikation und Beteiligung.</b>
                        </p>
                        <hr class="mt-2 border-punk-blue dark:border-darkpunk-blue"/>
                        <p class="text-center font-serif text-xl p-8">
                            Eine Hypothese am Anfang bringt dich zu einem Ergebnis am Ende. <b class="text-punk-blue dark:text-punk-blue">Erkenne den Unterschied zwischen Kausalität und Korrelation.</b>
                        </p>
                        <hr class="mt-2 border-punk-blue dark:border-darkpunk-blue"/>
                        <p class="text-center font-serif text-xl p-8">
                            Wirf deine Ideologien über Board. <b class="text-punk-blue dark:text-punk-blue">Erschaffe das, was gebraucht wird.</b> Nicht irgendwas, das im Lehrbuch steht.
                        </p>
                        <hr class="mt-2 border-punk-blue dark:border-darkpunk-blue"/>
                        <p class="text-center font-serif text-xl p-8">
                            <b class="text-punk-blue dark:text-punk-blue">Sei Teil des Schiffes.</b> Betreibe keinen Katastrophentourismus, sondern verhindere das Unheil.
                        </p>
                    </div>
                    ...
                    <div class="p-4 xl:p-8 rounded-xl text-punk-light dark:text-darkpunk-light bg-punk-dark/80 dark:bg-darkpunk-dark/80">
                        ...
                        <p class="text-left font-serif text-xl py-2">
                            ...
                            <div class="text-center my-4">
                                <a class="text-xl lg:text-3xl p-4 rounded-xl mr-2 mt-2 inline-block
                                    bg-punk-green dark:bg-darkpunk-green text-punk-light dark:text-darkpunk-light hover:bg-punk-light hover:text-punk-green dark:hover:bg-darkpunk-light dark:hover:text-darkpunk-green" href="https://shop.spreadshirt.de/agile-punks/agile+punks+20-A5e2aea0ae447424d5b535303?productType=1047&sellable=xrXml797dlF13z9vNgjq-1047-22&appearance=2">Let me be your Hoodie, Baby!</a>
                            </div>
                        </p>
                    </div>
